...
Now for testing, I mount my `gargle` cached authentifications(and other google auths too)  into the container and edit `run.sh` removing the parameters to the 
first render (see [here](https://github.com/mozilla/webrender_intel_win10_nightly/blob/master/run.sh#L17)) command and then
